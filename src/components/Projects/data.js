...
const data = {
  ...
  projectTwo: {
    title: 'Titon Toolkit',
    image: '../images/projects/titon.jpg',
    content: {
      ...
      technologies: ['React', 'Javascript/ES6', 'SASS', 'Flowtype', 'Jest'],
  ...
  projectThree: {
    ...
    content: {
      ...
      responsibilities: ['Front End Development'],
      technologies: ['React', 'Javascript/ES6', 'SASS', 'Webpack', 'Node'],
  ...
  projectFive: {
    ...
    image: '../images/projects/palisades.jpg',
    content: {
      ...
      responsibilities: ['Front End Development', 'Parallax Effect'],
      technologies: ['HTML5', 'CSS3', 'Javascript', 'Jquery'],
  ...
  projectSix: {
    ...
    image: '../images/projects/thfh.jpg',
    content: {
  ...
  projectSeven: {
    ...
    image: '../images/projects/sbt2.jpg',
    content: {
      ...
      responsibilities: ['Front End Development', 'UI/UX Design'],
      technologies: ['HTML5', 'CSS3', 'Javascript', 'Jquery'],
      image: '../images/projects/sbt.png',
      href: 'http://southbaytrainer.com/',
    },
